...
//     выводи alert с предупреждением о том, что
//     все поля должны быть заполнены.
// Если пользователь заполнил все поля и отправил
// форму, собери значения полей в обьект, где имя
// поля будет именем свойства, а значение поля - значением
...
function handleSubmit(event) {
  ...
  if (password.value === "" && email.value === "") {
    return window.alert("Pleas enter your email and password");
  }
